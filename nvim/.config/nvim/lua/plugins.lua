...
use {
  'hrsh7th/cmp-vsnip',                                      -- nvim-cmp completion source
  requires = {
...
use {                                                       -- treesitter aware auto-close html tags
...
use 'JoosepAlviste/nvim-ts-context-commentstring'           -- update commentstring using treesitter for injected languages
